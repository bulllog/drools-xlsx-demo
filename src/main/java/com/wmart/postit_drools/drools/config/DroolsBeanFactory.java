package com.wmart.postit_drools.drools.config;
...
public class DroolsBeanFactory {
    ...
    private static final String RULES_PATH = "/rules/v1";
...
//        kieFileSystem.write(ResourceFactory.newClassPathResource("com/baeldung/drools/rules/Product_rules.xls"));
    ...
    public KieSession getKieSession(Resource dt) {
        ...
        if (kieBuilder.getResults().hasMessages(Message.Level.ERROR)){
            System.out.println("KIE MODULE ERRORS - " + kieBuilder.getResults().getMessages(Message.Level.ERROR));
        }
    ...
    /**
     * Returns the kiesession for given drl string.
     *
     * @param drlString
     * @return
     */
    public KieSession getKieSession(String drlString) {
        KnowledgeBuilder builder = KnowledgeBuilderFactory.newKnowledgeBuilder();

        builder.add( ResourceFactory.newByteArrayResource( drlString.getBytes() ), ResourceType.DRL );
    ...
    /**
     * Parse the drl string to list down the errors in the drl.
     * @param drl
     */
    public void verfiy(String drl) {
        ...
        {
            System.out.println("This rule No any errors,Cherry!!");
        }
        else
        {
